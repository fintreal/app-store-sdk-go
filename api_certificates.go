...
// Certificate representation
func (r ApiCertificatesUpdateInstanceRequest) CertificateUpdateRequest(certificateUpdateRequest CertificateUpdateRequest) ApiCertificatesUpdateInstanceRequest {
	r.certificateUpdateRequest = &certificateUpdateRequest
	return r
}

func (r ApiCertificatesUpdateInstanceRequest) Execute() (*CertificateResponse, *http.Response, error) {
	return r.ApiService.CertificatesUpdateInstanceExecute(r)
}
...
func (a *CertificatesAPIService) CertificatesUpdateInstanceExecute(r ApiCertificatesUpdateInstanceRequest) (*CertificateResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.certificateUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("certificateUpdateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.certificateUpdateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
